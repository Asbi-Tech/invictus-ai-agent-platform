#!/usr/bin/env python3
"""
start_server.py – Launch the Invictus Deals Onboarding FastAPI backend.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Start the Invictus Deals Onboarding API server")
